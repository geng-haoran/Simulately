...
import { sortedPapers } from '@site/src/data/papers';
import { Paper } from '@site/src/shared/dto/Paper';
import { PaperTagType, PaperTags, PaperTagList } from '@site/src/shared/constants/PaperConsts';
...
function useFilteredUsers() {
  ...
  const [selectedTags, setSelectedTags] = useState<PaperTagType[]>([]);
  ...
  return useMemo(
    () => filterUsers(sortedPapers, selectedTags, operator, searchName),
  ...
  return (
    <section className="container margin-top--l margin-bottom--lg">
      ...
      <ul className={clsx('clean-list', styles.checkboxList)}>
        {PaperTagList.map((tag, i) => {
          const {label, description, color} = PaperTags[tag];
...
const isaacgymUsers = sortedPapers.filter((user) =>
  user.tags.includes('isaacgym'),
);
const otherUsers = sortedPapers.filter(
  (user) => !user.tags.includes('isaacgym'),
);
